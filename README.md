...
- [apps.sh](install/apps.sh) - install _Homebrew_, _Homebrew Cask Upgrade_ and applications.
  ...
  - Homebrew casks: [Adguard](https://adguard.com/), [Adobe Creative Cloud](https://creative.adobe.com/products/creative-cloud), [Dash](https://kapeli.com/dash), [Fira Code](https://github.com/tonsky/FiraCode), [Google Chrome](https://www.google.com/chrome/), [IINA](https://iina.io/), [iStat Menus](https://bjango.com/mac/istatmenus), [iTerm2](https://iterm2.com), [Paragon NTFS](https://www.paragon-software.com/ufsdhome/ntfs-mac/), [PDF Expert](https://pdfexpert.com/), [qBittorrent](https://www.qbittorrent.org/) and [Visual Studio Code](https://code.visualstudio.com);
